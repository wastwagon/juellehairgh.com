...
export function CheckoutForm() {
  ...
  const subtotalGhs = items.reduce((sum, item) => {
    const price = item.product?.priceGhs ? Number(item.product.priceGhs) : 0;
        ...
        <div className="lg:col-span-1">
          <div className="bg-white border border-gray-200 rounded-lg p-6 sticky top-4 shadow-sm">
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold py-3 rounded-lg shadow-lg hover:shadow-xl disabled:opacity-50 transition-all duration-300 transform hover:scale-[1.02] disabled:transform-none"
            >
