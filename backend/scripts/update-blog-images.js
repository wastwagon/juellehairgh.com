...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var blogImageMap, posts, _i, posts_1, post, imageUrl;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    post = posts_1[_i];
                    imageUrl = blogImageMap[post.title];
                ...
                case 3:
                    _a.sent();
                    console.log("\u2705 Updated \"".concat(post.title, "\" with image: ").concat(imageUrl));
                    return [3 /*break*/, 6];
                case 4: 
                ...
                case 5:
                    // Use a default image if no specific match
                    _a.sent();
                    console.log("\u2705 Updated \"".concat(post.title, "\" with default image"));
                    _a.label = 6;
                case 6:
                    _i++;
                    return [3 /*break*/, 2];
